      ...
      <div style={{ minHeight: '100vh', maxWidth: 680, margin: '0 auto', padding: '64px 28px 0', position: 'relative', zIndex: 1 }}>
        ...
        <div className='pixel-border-dim'
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
            <div style={{ fontFamily: 'var(--font-pixel)', fontSize: 12, color: 'var(--gray-4)', letterSpacing: '0.1em' }}>[ .TXT / .MD 업로드 ]</div>
        ...
        <div style={{ marginBottom: 28 }}>
          <div style={{ fontFamily: 'var(--font-pixel)', fontSize: 12, color: 'var(--gray-4)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: 10 }}>► 직접 붙여넣기</div>
